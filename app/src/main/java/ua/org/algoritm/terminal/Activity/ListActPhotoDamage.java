...
public class ListActPhotoDamage extends AppCompatActivity {
    private TypeDamagePhoto mTypeDamagePhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTypeDamagePhoto = SharedData.getTypeDamagePhoto(actInspectionID, detailID, typesPhotoID);

        setTitle(mTypeDamagePhoto.getName());
        ...
        ItemTouchHelper.SimpleCallback itemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                mDialog = new ProgressDialog(ListActPhotoDamage.this);
                mDialog.setMessage(getString(R.string.wait));
                mDialog.setCancelable(false);
                mDialog.show();

                PhotoActInspection mPhoto = mTypeDamagePhoto.getPhotoActInspections().get(fromPos);

                mTypeDamagePhoto.getPhotoActInspections().remove(mPhoto);
                IntentServiceDataBase.startDeletePhotoActInspection(ListActPhotoDamage.this, mPhoto.getCurrentPhotoPath());
            }
        };
    ...
    private void updateListsPhoto() {
        if (adapterPhoto == null) {
            adapterPhoto = new RecyclerAdapterPhotoActInspection(this, R.layout.item_photo, mTypeDamagePhoto.getPhotoActInspections());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IntentServiceDataBase.REQUEST_CODE_DELETE_PHOTO_ACT_INSPECTION) {
            ...
            adapterPhoto.setPhotoActInspection(mTypeDamagePhoto.getPhotoActInspections());
            updateListsPhoto();
